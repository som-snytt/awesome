...
//   val scalapFormatter = new awesome.scalap.ScalapFormatter
//   
//   val formatter = ScalaFormatter
//   
//   def printMethods(
//     comment: String,
...
//       // val strs = yes sortBy (_.name) map (_.toScalaString)
//       val strs = yes sortBy (_.name) map formatter.signature
...
//   def apply(cf: ClassFile): String = scalapFormatter(cf.className)
